...
public class TestaMetodo {
	public static void main(String[] args) {
		...
		System.out.println("O saldo após o saque é " + contaDaYasmim.saldo);
		...
		System.out.println("O saldo na conta da Yasmim é de " + contaDaYasmim.saldo);
		System.out.println("O saldo na conta da Gi é de " + contaDaGi.saldo);
